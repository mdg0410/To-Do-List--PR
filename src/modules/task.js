export default class Task {
  ...
  createNode() {
    ...
    taskNode.setAttribute('readonly', true);
    taskNode.innerHTML = `
    <div class="task-item-container">
      ...
      <form name="task-${this.index}" autocomplete="off">
        <input type="text" class="task-item ${this.completed ? 'task-completed' : ''}" required name="description" data-task-id="${this.index}" value="${this.description}" readonly/>
